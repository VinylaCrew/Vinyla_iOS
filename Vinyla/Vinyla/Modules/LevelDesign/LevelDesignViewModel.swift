...
final class LevelDesignViewModel {
    private var levelDesignCellID: String = "LevelDesignCell"
    ...
    init() {
        ...
        levelDesignModel.append(LevelDesignModel(levelImageName: "icnHomeLv2", level: "LV.2", levelName: "닐리즈 (2~9)", levelMent: "바이닐 수집의 매력을 알게된 리즈시절"))
